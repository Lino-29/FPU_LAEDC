...
module rounding (
    input  wire [25:0] mul_normalize,   // [25:3] significand | [2] guard | [1] round | [0] sticky
    output wire [22:0] mul_single
);

    wire guard_bit   = mul_normalize[2];
    wire round_bit   = mul_normalize[1];
    wire sticky_bit  = mul_normalize[0];
